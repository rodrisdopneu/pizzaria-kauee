  ...
  return (
    <>
      ...
      <section className="hero">
        <div className="hero-photo"><img src="/menu/banner-clean-forno.png" alt="Pizza artesanal forno a lenha" /></div>
      ...
      <section className="special-banner">
        <div className="special-photo"><img src="/menu/banner-clean-especiais.png" alt="Pizza especial da Pizzaria Kaue" /></div>
        <p>Experimente</p>
  ...
  return (
    <>
      ...
      <div className="menu-banner">
        <span><img src="/menu/banner-clean-delivery.png" alt="" /></span>
...
.top,.menu-head,.inner-head{position:sticky;top:0;z-index:50;background:rgba(10,10,10,.9);backdrop-filter:blur(18px);border-bottom:1px solid rgba(255,255,255,.08)}.top{display:flex;align-items:center;justify-content:space-between;padding:14px 16px}.brand{display:flex;align-items:center;gap:10px;background:transparent;color:${C.white};text-align:left}.brand>span{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:#050505;border:1px solid rgba(255,140,0,.55);overflow:hidden;box-shadow:0 0 22px rgba(255,140,0,.16);padding:3px}.brand>span img{width:100%;height:100%;object-fit:contain;border-radius:50%}.brand strong{font-family:'Manrope',sans-serif;color:${C.white};font-size:18px;font-weight:900;letter-spacing:-.4px;line-height:.95}.brand small{display:block;color:#48d36f;font-size:9px;font-weight:800;letter-spacing:0;margin-top:3px}.brand.compact>span{width:38px;height:38px;padding:3px}.brand.compact strong{font-size:15px}.top-actions{display:flex;align-items:center;gap:9px}.saved{display:none;color:#4caf50;border:1px solid rgba(76,175,80,.35);border-radius:10px;padding:4px 8px;font-size:10px}.delivery{display:flex;align-items:center;gap:5px;background:rgba(255,140,0,.08);border:1px solid rgba(255,140,0,.55);border-radius:18px;color:#ff9b23;font-size:11px;font-weight:800;padding:6px 10px}.cart-icon{background:transparent;color:${C.white};position:relative;padding:5px}.cart-icon span,.cart-icon em{position:absolute;top:-3px;right:-3px;background:${C.orange};border-radius:50%;width:18px;height:18px;display:grid;place-items:center;font-size:10px;font-style:normal}
.hero{position:relative;display:block;padding:0 0 28px;overflow:hidden;background:#080808}.hero-photo{position:relative;width:100%;height:265px;overflow:hidden;opacity:.98;filter:saturate(1.05) contrast(1.04);box-shadow:0 22px 60px rgba(0,0,0,.45)}.hero-photo img{width:100%;height:100%;object-fit:cover;object-position:center}.hero-content{position:relative;z-index:2;max-width:none;padding:22px 24px 0}.eyebrow{font-size:10px;letter-spacing:2.6px;color:#ff9b23;font-weight:900}.hero h1{font-family:'Manrope';line-height:.9;margin:10px 0 12px;letter-spacing:-2px}.hero h1 span,.hero h1 strong{display:block;font-size:58px;font-weight:900}.hero h1 strong{color:#ff8c00;text-shadow:0 0 34px rgba(255,140,0,.38)}.hero-copy{color:#d0d0d0;font-size:13px;line-height:1.65;max-width:320px}.order-button{display:flex;align-items:center;gap:12px;background:rgba(24,24,24,.9);border:1px solid rgba(255,255,255,.1);border-radius:14px;color:${C.white};padding:14px 16px;box-shadow:0 18px 45px rgba(0,0,0,.3)}.order-button svg{color:${C.orange}}.order-button span{display:grid;text-align:left}.order-button small{color:${C.gray};font-size:11px}
.features{display:grid;grid-template-columns:repeat(4,1fr);background:rgba(20,20,20,.98);border-top:1px solid rgba(255,255,255,.08);border-bottom:1px solid rgba(255,255,255,.08)}.features div{padding:16px 5px;text-align:center;border-right:1px solid rgba(255,255,255,.07);font-size:9px;color:${C.grayLight};text-transform:uppercase;font-weight:700}.features svg,.bottom-info svg{color:${C.orange};display:block;margin:0 auto 6px}.special-banner{margin:16px;border-radius:18px;background:#111;border:1px solid rgba(255,140,0,.24);padding:0;position:relative;overflow:hidden;box-shadow:0 22px 55px rgba(0,0,0,.35)}.special-banner p,.special-banner h2,.special-banner button{margin-left:18px;margin-right:18px}.special-banner p{font-size:10px;letter-spacing:2px;color:#d2d2d2;text-transform:uppercase;margin-top:16px;margin-bottom:0}.special-banner h2{font-family:'Manrope';line-height:.95;font-size:25px;font-weight:900;margin-top:5px;margin-bottom:16px;letter-spacing:-.6px}.special-banner h2 span{color:${C.orange}}.special-banner button{display:flex;align-items:center;gap:8px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.35);border-radius:999px;color:${C.white};font-weight:900;font-size:12px;padding:9px 16px;margin-bottom:18px}.special-photo{position:relative;width:100%;height:150px;z-index:0}.special-photo img{width:100%;height:100%;object-fit:cover;object-position:center}
