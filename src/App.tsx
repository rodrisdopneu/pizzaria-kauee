  ...
  return (
    <>
      ...
      <section className="hero">
        <div className="hero-photo"><img src="/menu/calabresa.png" alt="Pizza artesanal forno a lenha" /></div>
      ...
      <section className="special-banner">
        ...
        <div className="special-photo"><img src="/menu/quatro-queijos.png" alt="Pizza especial da Pizzaria Kaue" /></div>
      </section>
  ...
  return (
    <>
      ...
      <div className="menu-banner">
        ...
        <span><img src="/menu/carne-seca.png" alt="" /></span>
      </div>
      {cat === "todos" && (
        <>
